export const MENUS = [
  ...
  export const data = [
    ...
    },
    {
      ...
      spec: [{ Display: "17 inch", Resolution: "2360 x 1640", Storage: "16GB" }],
      image:
      ...
      spec: [
        {
          ...
          Rate: "60Hz",
          Hard_Drive: "512GBWeight ",
          CPU: "Intel Core i7-1250U",
          RAM: "16GB",
          Display_Resolution: "2880*1800Keyboard",
        },
      ],
    ...
    },
    {
      ...
      spec: [{ Height: "8.27 inches", Width: "4.92inches" }],
      ...
      spec: [
        {
          ...
          Special_Feature: "Salsa, Cocktails, Ground Coffee, Smoothies, Grated cheese"
        },
      ],
    ...
    {
      description: "Fitbit Luxe Fitness and Wellness Tracker with Stress Management, Sleep Tracking and 24/7 Heart Rate, Orchid/Platinum Stainless Steel, One Size, S & L Bands Included",
      spec: [
        {
          Brand: "Fitbit",
